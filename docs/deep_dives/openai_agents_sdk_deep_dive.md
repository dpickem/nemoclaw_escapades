...
3. [Architecture at a Glance](#3--architecture-at-a-glance)
   - [3.1 Sandbox Lifecycle](#31-sandbox-lifecycle-from-docssandboxguidemd)
4. [Sandbox Agents — The Headline Feature](#4--sandbox-agents--the-headline-feature)
   - [4.1 `default_manifest`](#41-default_manifest)
   - [4.2 `capabilities`](#42-capabilities)
   - [4.3 `run_as`](#43-run_as)
   - [4.4 `base_instructions`](#44-base_instructions)
5. [Manifests: A First-Class Workspace Contract](#5--manifests-a-first-class-workspace-contract)
   - [5.1 Why This Matters for NemoClaw](#51-why-this-matters-for-nemoclaw)
   - [5.2 The `extra_path_grants` Idea](#52-the-extra_path_grants-idea)
6. [Capabilities: Composable Sandbox-Native Tools](#6--capabilities-composable-sandbox-native-tools)
   - [6.1 The Capability Lifecycle](#61-the-capability-lifecycle)
   - [6.2 Lesson for NemoClaw](#62-lesson-for-nemoclaw)
7. [Snapshots and Session State](#7--snapshots-and-session-state)
8. [Lazy Skills with `load_skill`](#8--lazy-skills-with-load_skill)
   - [8.1 What the SDK Does](#81-what-the-sdk-does)
   - [8.2 What NemoClaw Does Today](#82-what-nemoclaw-does-today)
   - [8.3 Adoption Recommendation](#83-adoption-recommendation)
9. [Sandbox Agents as Tools and Handoffs](#9--sandbox-agents-as-tools-and-handoffs)
   - [9.1 Pattern A — Sandbox Agent as a Tool](#91-pattern-a--sandbox-agent-as-a-tool)
   - [9.2 Pattern B — Handoffs](#92-pattern-b--handoffs)
   - [9.3 Lesson for NemoClaw](#93-lesson-for-nemoclaw)
...
11. [What to Adopt — Prioritized](#11--what-to-adopt--prioritized)
    - [11.1 Tier 1 — Adopt now](#111-tier-1--adopt-now-low-cost-high-value)
    - [11.2 Tier 2 — Adopt when M3 starts](#112-tier-2--adopt-when-m3-starts-multi-sandbox)
    - [11.3 Tier 3 — Adopt when refactoring](#113-tier-3--adopt-when-refactoring-m3-design-vocabulary)
12. [What Not to Adopt](#12--what-not-to-adopt)
    - [12.1 `BaseSandboxClient`](#121-basesandboxclient)
    - [12.2 `Runner.run()` and the OpenAI Responses-API runner](#122-runnerrun-and-the-openai-responses-api-runner)
    - [12.3 SDK Tracing](#123-sdk-tracing)
    - [12.4 Realtime Voice Agents](#124-realtime-voice-agents)
    - [12.5 Server-Managed Conversations](#125-server-managed-conversations-conversation_id-previous_response_id)
13. [Open Questions](#13--open-questions)
14. [Appendix A — Useful SDK Code Pointers](#appendix-a--useful-sdk-code-pointers)
15. [Appendix B — Mapping NemoClaw Files to SDK Equivalents](#appendix-b--mapping-nemoclaw-files-to-sdk-equivalents)
16. [Appendix C — Glossary Differences](#appendix-c--glossary-differences)
