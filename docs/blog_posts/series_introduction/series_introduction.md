...
Because "from scratch" is the best way to build lasting understanding of new concepts. Just like Sebastian Raschka did with his books [Build a Large Language Model (From Scratch)](https://www.manning.com/books/build-a-large-language-model-from-scratch) or his latest book [Build a Reasoning Model (From Scratch)](https://www.manning.com/books/build-a-reasoning-model-from-scratch) I am attempting to do with a personal assistant-style multi-agent system.
